...
```bash
npm install -g https://github.com/Ajayos/nodemon # or using yarn: yarn global add nodemon
```
...
```bash
npm install --save-dev https://github.com/Ajayos/nodemon # or using yarn: yarn add nodemon -D
```
